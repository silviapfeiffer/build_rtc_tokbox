/**
 * @license  OpenTok JavaScript Library v2.2.9.2
 * http://www.tokbox.com/
 *
...
(function(window) {
  ...
  OT.properties = {
    version: 'v2.2.9.2',         // The current version (eg. v2.0.4) (This is replaced by gradle)
    build: '32ab605',    // The current build hash (This is replaced by gradle)
...
/**
 * @license  TB Plugin 0.4.0.8 32ab605 HEAD
 * http://www.tokbox.com/
 *
 * Copyright (c) 2014 TokBox, Inc.
 *
...
*/
  OT.checkSystemRequirements = function() {
    // HACK TO GET PAST THIS
    return 1;

    OT.debug('OT.checkSystemRequirements()');

    // Try native support first, then TBPlugin...
    var systemRequirementsMet = OT.$.hasCapabilities('websockets') ||
